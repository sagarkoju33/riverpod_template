...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<dynamic> get values => [aGitkeep, launcher];
}
...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/profileimage.jpeg
  AssetGenImage get profileimage =>
      const AssetGenImage('assets/images/profileimage.jpeg');

  /// List of all assets
  List<dynamic> get values => [aGitkeep, profileimage];
}
